...
public class DriveTrain extends SubsystemBase {
  ...
  public DriveTrain() 
  {
    ...
    sparkFL.setClosedLoopRampRate(1);
    sparkFR.setClosedLoopRampRate(1);
    sparkBL.setClosedLoopRampRate(1);
    sparkBR.setClosedLoopRampRate(1);
    sparkFL.setOpenLoopRampRate(1);
    sparkFR.setOpenLoopRampRate(1);
    sparkBL.setOpenLoopRampRate(1);
    sparkBR.setOpenLoopRampRate(1); 
  ...
  public void periodic() 
  {
   // setDefaultCommand(new Drive(getXboxXSpeed(), getXboxYSpeed()));
    SmartDashboard.putNumber("FL Motor", sparkFL.getOutputCurrent());
    SmartDashboard.putNumber("FR Motor", sparkFR.getOutputCurrent());
    SmartDashboard.putNumber("BL Motor", sparkBL.getOutputCurrent());
    SmartDashboard.putNumber("BR Motor", sparkBR.getOutputCurrent());
  }
