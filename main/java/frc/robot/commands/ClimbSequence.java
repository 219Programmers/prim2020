...
public class ClimbSequence extends SequentialCommandGroup {
  ...
  public static SequentialCommandGroup climbSeq(boolean down)
  {
    if(down)
    {
      return new ClimberPneumGo(false).andThen(new ClimbNow(true, 0.4, 2, true), new ClimbNow(false, 80, false, 0.5));
    }
    return new ClimberPneumGo(false).andThen(new ClimbNow(true, 19000, true, 0.75));
  }
